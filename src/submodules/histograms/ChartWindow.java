...
public class ChartWindow extends ImageWindow implements ActionListener, ClipboardOwner,
	...
	private static Chart staticPlot;
	private Chart plot;
	...
	*/
	public ChartWindow(String title, String xLabel, String yLabel, float[] xValues, float[] yValues) {
	...
	* replaced by the Plot class.
	*/
	public ChartWindow(String title, String xLabel, String yLabel, double[] xValues, double[] yValues) {
		this(title, xLabel, yLabel, Tools.toFloat(xValues), Tools.toFloat(yValues));
	}
	
	/** Creates a PlotWindow from a Plot object. */
	ChartWindow(Chart plot) {
	...
	static ImagePlus createImage(String title, String xLabel, String yLabel, float[] xValues, float[] yValues) {
		staticPlot = new Chart(title, xLabel, yLabel, xValues, yValues);
	...
	*/
	...
	public void drawPlot(Chart plot) {
		this.plot = plot;
		if (imp!=null)
