...
public class Chart {
	 ...
	 */
	public Chart(String title, String xLabel, String yLabel, float[] xValues, float[] yValues) {
		this(title, xLabel, yLabel, xValues, yValues, DEFAULT_FLAGS);
	}

	/** This version of the constructor accepts double arrays. */
	public Chart(String title, String xLabel, String yLabel, double[] xValues, double[] yValues) {
	...
	public Chart(String dummy, String title, String xLabel, String yLabel, float[] xValues, float[] yValues) {
		this(title, xLabel, yLabel, xValues, yValues, DEFAULT_FLAGS);
	}
	...
	/** This is a version of the constructor with no intial arrays. */
	public Chart(String title, String xLabel, String yLabel, int flags) {
	...
	*/
	public Chart(String title, String xLabel, String yLabel, float[] xValues, float[] yValues, int flags) {
		this.title = title;
		this.xLabel = xLabel;
		this.yLabel = yLabel;
		this.flags = flags;
	...
	public Chart(String title, String xLabel, String yLabel, double[] xValues, double[] yValues, int flags) {
	...
	public ChartWindow show() {
		...
		ChartWindow pw = new ChartWindow(this);
